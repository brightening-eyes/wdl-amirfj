...
class IPlugVST3Plugin : public IPlugBase
                , public IUnitInfo
                , public SingleComponentEffect
{
public:
  IPlugVST3Plugin(IPlugInstanceInfo instanceInfo,
            int nParams,
...
//    kAftertouchParam = 'aftt',
  ...
  OBJ_METHODS (IPlugVST3Plugin, SingleComponentEffect)
  DEFINE_INTERFACES
...
IPlugVST3Plugin* MakePlug();

class IPlugVST3View : public CPluginView
{
public:
  IPlugVST3View(IPlugVST3Plugin* pPlug);
  ~IPlugVST3View ();
